...
# Hits the real YouTube Data API to confirm the configured key/handle can
# actually fetch channel data (requires real Airflow variables, not mocks).
...
# Opens a real connection to the Postgres warehouse and runs a trivial
# query to verify connectivity/credentials outside of any mocks.
